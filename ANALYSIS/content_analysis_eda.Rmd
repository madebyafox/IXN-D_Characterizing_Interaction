...
(p <- gf_bar( PNUM ~., fill = ~ fct_rev(code_detail), data = df_process) %>% 
  ...
  scale_fill_brewer(type="qual", palette = 3) +
  labs(
    title = "Process Utterances by Participant, Dataset and Task",
    subtitle = "",
    x = "number of coded utterances",
    y = "participant",
    fill = "TOPIC"
...
(p <- gf_bar( PNUM ~., fill = ~ fct_rev(code_detail), data = df_variable) %>% 
  ...
  scale_fill_brewer(type="seq", palette = 5) +
  labs(
    title = "Variable Utterances by Participant, Dataset and Task",
    subtitle = "",
    x = "number of coded utterances",
    y = "participant",
    fill = "TOPIC"
...
ggsave(p, file="figures/variables_counts.png")
...
(p <- gf_bar( PNUM ~., fill = ~ fct_rev(code_detail), data = df_relationship) %>% 
  ...
  scale_fill_brewer(type="seq", palette = 3) +
  labs(
    title = "Relationship Utterances by Participant, Dataset and Task",
    subtitle = "",
    x = "number of coded utterances",
    y = "participant",
    fill = "TOPIC"
