...
#TOPIC $
(p <-ggplot(df_summary, aes(y=freq, x = dumm, fill= fct_rev(code_topic))) + 
  geom_col() + 
  ...
  labs( title = "TOPIC OF UTTERANCES",
        ...
        x= "TASK", y = "count") + theme_minimal() )
ggsave(p, file="figures/topic-frequency.png")
...
ggsave(p, file="figures/topics_in_time_FACET.png")
...
ggsave(p, file="figures/topics_in_time_STACK.png")
...
ggsave(p, file="figures/telemetry_reptypes_by_factors.png")
# + theme(legend.position = "blank")
...
ggsave(p, file="figures/telemetry_REPS_by_factors.png", width = 7, height = 5, units ="in")
...
ggsave(p, file="figures/uttrep_high_time_FACET.png")
...
ggsave(p, file="figures/uttrep_high_time_STACK.png")
